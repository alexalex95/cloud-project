        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 text">
                    <center><h1><strong>CREAR ADMINISTRADOR <i class="fa fa-user-plus"></i></strong></h1></center>
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom well">
                        <form role="form" id="formulario3" action="procesos/agregarAdmin.php" method="POST" class="login-form">
                            ...
                            <br>
                            <br>
                            <button type='submit' id="registro3" class='btn btn-success'>Crear Admin</button>
                        </form>
                    </div>
                </div>
            </div>
