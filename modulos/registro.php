            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom">
                        <form role="form" id="formulario" action="../procesos/registroNuevo.php" method="POST" class="login-form">
                            <label>Nombre: </label>
                            ...
                            <br>
                            <br>
                            <button type='submit' id="registro" class='btn'>Registrarse</button>
